...
class OnChoseImageSignUp extends StatefulWidget {
  @override
  _OnChoseImageSignUpState createState() => _OnChoseImageSignUpState();
}

class _OnChoseImageSignUpState extends State<OnChoseImageSignUp> {
  @override
  Widget build(BuildContext context) {
